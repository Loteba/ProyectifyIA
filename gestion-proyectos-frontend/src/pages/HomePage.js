...
import { FaBolt, FaSearch, FaFolderOpen, FaUsers, FaComments, FaChartLine, FaLightbulb, FaShieldAlt } from 'react-icons/fa';
import './HomePage.css';
    ...
    <div className="home-wrap">
      ...
      <section className="home-hero" aria-label="Portada ProyectifyIA">
        ...
        <div className="hero-content">
          <h1>ProyectifyIA — Tu asistente de investigación con IA</h1>
          <p>
      ...
      <div className="container benefits shelf">
        ...
        <div className="benefit-card">
          ...
          <h3>Inspírate con ejemplos</h3>
          <p>Plantillas y tips para redactar introducciones y resúmenes.</p>
        </div>
        <div className="benefit-card">
          <div className="benefit-icon"><FaShieldAlt /></div>
          <h3>Cuida tus avances</h3>
          <p>Toda tu información se guarda de forma privada y segura.</p>
        </div>
      </div>
      </section>
      ...
      <section className="container features" aria-label="Características">
        ...
        <article className="feature-card">
          <div className="feature-media">
            <img src="https://images.unsplash.com/photo-1504384308090-c894fdcc538d?q=80&w=1200&auto=format&fit=crop" alt="Recordatorios inteligentes" />
          </div>
          <div className="feature-text">
            <h3>Recordatorios inteligentes</h3>
            <p>Recibe avisos amables antes de cada entrega o reunión.</p>
            <ul>
              <li>Alertas por correo justo a tiempo</li>
              <li>Configura qué proyectos vigilar</li>
              <li>Descansa sabiendo que no olvidarás nada</li>
            </ul>
          </div>
        </article>
        ...
        <article className="feature-card">
          <div className="feature-media">
            <img src="https://images.unsplash.com/photo-1487611459768-bd414656ea10?q=80&w=1200&auto=format&fit=crop" alt="Notas y bitácoras" />
          </div>
          <div className="feature-text">
            <h3>Notas y bitácoras</h3>
            <p>Deja comentarios rápidos para ti o tu equipo junto a cada recurso.</p>
            <ul>
              <li>Apunta ideas y pendientes al vuelo</li>
              <li>Comparte bitácoras con tus colaboradores</li>
              <li>Todo queda organizado por proyecto</li>
            </ul>
          </div>
        </article>
      </section>
